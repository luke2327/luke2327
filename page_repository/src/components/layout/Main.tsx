...
export default function Main() {
  ...
  return (
    <main id="resume">
      <aside className="fixed top-24 right-0 mx-8 p-2">
        <nav className="hidden max-w-[200px] flex-col gap-2 ld:flex">
          <ul>
            <li>
              <a
                href="#profile"
                className={currentNav === 'profile' ? 'text-gray-light' : ''}
              >
                Profile
              </a>
            </li>
            <li>
              <a
                href="#skill"
                className={currentNav === 'skill' ? 'text-gray-light' : ''}
              >
                Skill
              </a>
            </li>
            <li>
              <a
                ...
                className={
                  currentNav === 'work-experience' ? 'text-gray-light' : ''
                }
              >
                Work Experience
              </a>
            ...
            <li>
              <a
                href="#side-projects"
                className={
                  currentNav === 'side-projects' ? 'text-gray-light' : ''
                }
              >
                Side Projects
              </a>
            ...
            <li>
              <a
                href="#associate-company"
                className={
                  currentNav === 'associate-company' ? 'text-gray-light' : ''
                }
              >
                Associate Company
              </a>
            ...
            <li>
              <a
                href="#link"
                className={currentNav === 'link' ? 'text-gray-light' : ''}
              >
                Link
              </a>
            </li>
            ...
            >
              <a
                href="#contact"
                className={currentNav === 'contact' ? 'text-gray-light' : ''}
              >
                Contact
              </a>
            </li>
      ...
      <div
        id={'profile'}
        className={'mx-auto px-4 pb-28 pt-24 sm:max-w-[36rem]'}
      >
        <div ref={profileRef}>
          <Card>
            <AnimateItems
      ...
      >
        <div className="fixed bottom-0 flex w-full justify-center pb-8">
          <motion.div
            animate={{ y: 20 }}
            transition={{
              duration: 2,
